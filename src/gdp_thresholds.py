...
gwfvisdb_url = (
    'https://gwf-vis.usask.ca/v1/api/file/fetch/public/datasets/gdp.gwfvisdb'
)
...
values_for_variable = list(map(lambda x: x.value ,filter(lambda x: x.variable.name == 'GDP', options.values)))
quantiles = [
